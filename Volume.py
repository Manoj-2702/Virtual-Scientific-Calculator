...
def volume_finder():
    ...
    def Torus():
        ...
        def calculate():
            a1 = int(E1.get())
            a2 = int(E2.get())
            A = round((2*math.pi*a1)*(math.pi*a2**2),4)
            Lab = Label(Vol, text=f"Volume={A}", font=("Arial", 20), bg="cyan")
            Lab.place(x=10, y=250)
            def clear_everything():
                L2.destroy()
    ...
    def show():
        ...
        if opt == "9.Tetrahedron":
            Tetrahedron()
    option = ["1.Cuboid", "2.Cube", "3.Cone", "4.Cylinder", "5.Square_Pyramid", "6.Torus","7.Sphere","8.Hemisphere", "9.Tetrahedron"]
