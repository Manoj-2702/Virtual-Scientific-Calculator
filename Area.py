...
def Area_finder():
    ...
    def Triangle2():
        ...
        def calculate():
            ...
            a3 = int(E3.get())
            s = (a1 + a2 + a3)/2
            A = round(math.sqrt(abs(s * (s - a1) * (s - a2) * (s - a3))), 4)
            Lab = Label(Are, text=f"Area = {A}", font=("Arial", 20), bg="orange")
            Lab.place(x=10, y=250)
            def clear_everything():
                E1.destroy()
    ...
    def show():
        ...
        if opt == "8.Semi-Circle":
            SemiCircle()
    option = ["1.Rectangle", "2.Square", "3.Triangle(2-sides known)", "4.triangle(3-sides known)","5.Trapezium", "6.Parallelogram", "7.Circle", "8.Semi-Circle"]
